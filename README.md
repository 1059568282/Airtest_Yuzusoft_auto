...
本项目旨在通过自动化脚本，简化《MLGG》游戏中的重复性操作。虽然目前脚本是基于众多Bug来运行，但我们欢迎并期待各位开发者和玩家的贡献，共同改进和优化代码。
...
This project aims to simplify repetitive operations in the game MLGG through automation. The current script operates based amount of bugs, and we welcome contributions from all developers and players to help improve and optimize the code.
